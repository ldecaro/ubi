package com.example.ubi.components.synthetic.compute.infrastructure;
...
public class ECS extends Construct{
    ...
    private ApplicationLoadBalancedFargateService alb = null;
    ...
    public ECS(Construct scope, final String id, final IEcsDeploymentConfig deploymentConfig, final String strEnvType, Network ecsNetwork){
        ...
        ApplicationLoadBalancedFargateService albService = ApplicationLoadBalancedFargateService.Builder.create(
                ...
                .deploymentController(DeploymentController.builder()
                        .type(DeploymentControllerType.ECS)//DeploymentControllerType.CODE_DEPLOY
                        .build())
                .taskDefinition(
        ...
        this.taskRole = albService.getService().getTaskDefinition().getTaskRole();      
        this.taskExecutionRole = albService.getService().getTaskDefinition().getExecutionRole();
        this.alb = albService;
    }
    ...
    public ApplicationLoadBalancedFargateService getALB(){
        return alb;
    }
    ...
    public FargateTaskDefinition createECSTask(
        ...
        taskDef = FargateTaskDefinition.Builder.create(this, "EcsTaskDef" + serviceName)
                ...
                .cpu(Integer.parseInt(ECS.ECS_TASK_CPU))
                .memoryLimitMiB(Integer.parseInt(ECS.ECS_TASK_MEMORY))
                .family(serviceName)
                .build();
